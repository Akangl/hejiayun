...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("Wenkang.Zhou")
                .setOutputDir("F:\\Java_Project\\family_service_platform\\family_service_platform\\src\\main\\java")//设置输出路径
        ...
        packageConfig.setParent("com.study.family_service_platform").setMapper("mapper")
